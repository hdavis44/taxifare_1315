...
def preprocess(min_date: str = '2009-01-01',
               max_date: str = '2015-01-01') -> None:
    """
...
def train(
        ...
        split_ratio:
    float = 0.02,  # 0.02 represents ~ 1 month of validation data on a 2009-2015 train set
    ...
    data_processed_train = data_processed.iloc[:train_length, :].sample(
        frac=1).to_numpy()
    data_processed_val = data_processed.iloc[train_length:, :].sample(
        frac=1).to_numpy()
